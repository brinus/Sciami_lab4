import numpy as np
from ROOT import TH1F, TLegend, TF1, TCanvas, TGraph, TDatime, gStyle, TPaveText
from ROOT import kRed, kBlue, Math
...
if __name__ == '__main__':
    ...
    testfunc = Math.Functor1D(flux1)
    GoF = Math.GoFTest(len(out[0]), out[0], testfunc, Math.GoFTest.kPDF, MIN, MAX)
    dn_1 = GoF.KolmogorovSmirnovTest('t')
    pvalue_1 = GoF.KolmogorovSmirnovTest()

    hT1.SetTitle('Flusso di raggi cosmici T2')
