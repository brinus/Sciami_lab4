import numpy as np
from ROOT import TH1F, TLegend, TF1, TCanvas, TGraph, TDatime, gStyle, kRed, TPaveText
...
if __name__ == '__main__':
    ...
    da = TDatime(2022,3,29,18,45,5)
    gStyle.SetTimeOffset(da.Convert())
    out = np.array([np.loadtxt(f'data/out{idx}_220329.out') for idx in range(1,9)], dtype='object')
    ...
    print(f'hT1 = {hT1.GetMean(2)/3600} +- {hT1.GetMean(22)/3600}')
    print(f'hT2 = {hT2.GetMean(2)/3600} +- {hT2.GetMean(22)/3600}')
    ...
    infos.AddText('RUN 29/03/22')
    infos.AddText('PLOT 10/04/22')
    # infos.AddText('T1 frequency = 62.67#pm0.25 Hz')
    # infos.AddText('T2 frequency = 59.90#pm0.28 Hz')
    ...
    func = TF1('f1', '[0] * x +[1]', 100e3, 300e3)
    func.SetParNames('m', 'q')
    g_corr.Fit('f1', 'FMRS')
    g_corr.GetXaxis().SetRangeUser(120e3, 230e3)
    ...
    infos2.AddText('RUN 29/03/22')
    infos2.AddText('PLOT 10/04/22')
    ...
    infos3.AddText('RUN 29/03/22')
    infos3.AddText('PLOT 10/04/22')
