...
from ROOT import TH1F, TF1, kBlue, kRed
...
if __name__ == '__main__':
    ...
    # Obtaining data
    ch, time, date, _, _ = make_out('events220324_5d.dat')
    ...
    # func1 = TF1('func1', '[0]*exp(-TMath::Abs(x)/[1])+[2]', diff.min(), diff.max())
    # func1.SetParameters(1e5, 1, 0)
    # func1.SetParNames('A', '#tau', 'q_0')
    # h1.Fit('func1', 'LIRMS')
    h1.Draw('E')
    # c1.Clear()
